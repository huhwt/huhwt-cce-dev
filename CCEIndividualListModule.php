...
/**
 * Class CCEIndividualListModule
 */
class CCEIndividualListModule extends IndividualListModule
                              implements ModuleListInterface, ModuleCustomInterface // , RequestHandlerInterface
{
    // use ModuleListTrait;
    ...
    protected const ROUTE_URL = '/tree/{tree}/CCEindividual-list';
    ...
    public function boot(): void
    {
        ...
        View::registerCustomView('::lists/surnames-table', $this->name() . '::lists/CCEsurnames-table');
    ...
    public function title(): string
    {
        ...
        return json_decode('"\u210D"') . "&" . json_decode('"\u210D"') . "wt " . I18N::translate('Individuals');
    }
            ...
            if ($show === 'indi' || $show === 'surn') {
                ...
                if ($show === 'surn') {
                    ...
                    switch ($tree->getPreference('SURNAME_LIST_STYLE')) {
                        ...
                        case 'style2':
                        default:
                            echo view('lists/CCEsurnames-table', [
     ...
     */
    public function families(Tree $tree, string $surname, array $surnames, string $galpha, bool $marnm): Collection
    {
