...
{   use ModuleMenuTrait;
     ...
     *      FamilyList:      add collected XREFs                                                -> 
    ...
    public function getShowAction(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $this->cartXREFs = $this->getXrefsFromCart($tree);
     ...
     * @return array
     */
    private function getXrefsFromCart(Tree $tree): array
    {
        $cart = Session::get('cart', []);
    ...
    public function boot(): void
    {
        ...
        Registry::routeFactory()->routeMap()
            ->get(ClippingsCartEnhancedModule::class, static::ROUTE_URL);
